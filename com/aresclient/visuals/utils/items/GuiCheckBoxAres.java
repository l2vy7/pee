 ...
 *  com.aresclient.visuals.utils.items.GuiCheckBoxAres
 ...
 */
public class GuiCheckBoxAres
extends GuiButton {
    public boolean state = false;
    private static Color color = Color.black;

    public GuiCheckBoxAres(int buttonId, int x, int y) {
        super(buttonId, x, y, "");
    }

    public void drawButton(Minecraft mc, int mouseX, int mouseY) {
        if (this.state) {
            GuiCheckBoxAres.drawTexture((ResourceLocation)new ResourceLocation("Ares/Icons/Toggles/true.png"), (float)this.xPosition, (float)this.yPosition, (float)50.0f, (float)50.0f);
        } else {
            GuiCheckBoxAres.drawTexture((ResourceLocation)new ResourceLocation("Ares/Icons/Toggles/false.png"), (float)this.xPosition, (float)this.yPosition, (float)50.0f, (float)50.0f);
        }
    }

    public boolean mousePressed(Minecraft mc, int mouseX, int mouseY) {
        return this.enabled && this.visible && mouseX >= this.xPosition && mouseY >= this.yPosition && mouseX < this.xPosition + 50 && mouseY < this.yPosition + this.height + 50;
    }
