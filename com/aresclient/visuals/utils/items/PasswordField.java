 ...
 *  com.aresclient.visuals.utils.items.PasswordField
...
extends Gui {
    ...
    public void writeText(String par1Str) {
        ...
        if (this.text.length() > 0) {
            var2 = String.valueOf(String.valueOf(String.valueOf(var2))) + this.text.substring(0, var4);
        }
        if (var6 < var3.length()) {
            var2 = String.valueOf(String.valueOf(String.valueOf(var2))) + var3.substring(0, var6);
            var8 = var6;
        } else {
            var2 = String.valueOf(String.valueOf(String.valueOf(var2))) + var3;
            var8 = var3.length();
        }
        if (this.text.length() > 0 && var5 < this.text.length()) {
            var2 = String.valueOf(String.valueOf(String.valueOf(var2))) + this.text.substring(var5);
        }
        ...
        if (this.text.length() != 0) {
            if (this.selectionEnd != this.cursorPosition) {
                ...
                if (var4 < this.text.length()) {
                    var5 = String.valueOf(String.valueOf(String.valueOf(var5))) + this.text.substring(var4);
                }
                this.text = var5;
                if (var2) {
                    this.cursorPos(par1);
    ...
    public int type(int par1, int par2, boolean par3) {
        ...
        var5 = par1 < 0;
        var6 = Math.abs(par1);
        block0: for (var7 = 0; var7 < var6; ++var7) {
            if (var5) ** GOTO lbl17
            var8 = this.text.length();
            if ((var4 = this.text.indexOf(32, var4)) != -1) ** GOTO lbl12
            var4 = var8;
            continue;
            while (var4 < var8 && this.text.charAt(var4) == ' ') {
                ++var4;
lbl12:
                // 2 sources
...
lbl17:
    ...
    public void drawTextBox() {
        if (this.func_73778_q()) {
            if (this.getEnableBackgroundDrawing()) {
                Gui.drawRect((int)(this.xPos - 1), (int)(this.yPos - 1), (int)(this.xPos + this.width + 1), (int)(this.yPos + this.height + 1), (int)-6250336);
                Gui.drawRect((int)this.xPos, (int)this.yPos, (int)(this.xPos + this.width), (int)(this.yPos + this.height), (int)-16777216);
            }
    ...
    private void drawCursorVertical(int par1, int par2, int par3, int par4) {
        ...
        var7.pos((double)par1, (double)par4, 0.0);
        var7.pos((double)par3, (double)par4, 0.0);
        var7.pos((double)par3, (double)par2, 0.0);
        var7.pos((double)par1, (double)par2, 0.0);
        var7.finishDrawing();
