...
extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        int i = -100;
        int j = 10;
        GuiAnimatedCapes.drawEntityOnScreen((int)(i + 51), (int)(j + 75), (int)30, (float)((float)(i + 51) - this.oldMouseX), (float)((float)(j + 75 - 50) - this.oldMouseY), (EntityLivingBase)this.mc.thePlayer);
        GuiAnimatedCapes.drawEntityOnScreen((int)x, (int)y, (int)95, (float)0.0f, (float)-25.0f, (EntityLivingBase)this.mc.thePlayer);
    ...
    private void updatebuttons() {
        int s = height / 10;
        int k = s * 3 - s / 2;
        this.buttonList.add(new ImageButton(1, 10, k - s * 1, s, s, new ResourceLocation("Ares/Capes/Animated/buttons/cape1.png")));
        this.buttonList.add(new ImageButton(2, 10, k, s, s, new ResourceLocation("Ares/Capes/Animated/buttons/cape2.png")));
        this.buttonList.add(new ImageButton(3, 10, k + s * 1, s, s, new ResourceLocation("Ares/Capes/Animated/buttons/cape3.png")));
        this.buttonList.add(new ImageButton(7, 10, k + s * 2, s, s, new ResourceLocation("Ares/Capes/Animated/buttons/cape7.png")));
        this.buttonList.add(new ImageButton(8, 10, k + s * 3, s, s, new ResourceLocation("Ares/Capes/Animated/buttons/cape8.png")));
        this.buttonList.add(new ImageButton(4, 20 + s, k - s * 1, s, s, new ResourceLocation("Ares/Capes/Animated/buttons/cape4.png")));
        this.buttonList.add(new ImageButton(5, 20 + s, k, s, s, new ResourceLocation("Ares/Capes/Animated/buttons/cape5.png")));
        this.buttonList.add(new ImageButton(6, 20 + s, k + s * 1, s, s, new ResourceLocation("Ares/Capes/Animated/buttons/cape6.png")));
