...
extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        int i = -100;
        int j = 10;
        GuiMoodyCapes.drawEntityOnScreen((int)(i + 51), (int)(j + 75), (int)30, (float)((float)(i + 51) - this.oldMouseX), (float)((float)(j + 75 - 50) - this.oldMouseY), (EntityLivingBase)this.mc.thePlayer);
        GuiMoodyCapes.drawEntityOnScreen((int)x, (int)y, (int)95, (float)0.0f, (float)-25.0f, (EntityLivingBase)this.mc.thePlayer);
    ...
    private void updatebuttons() {
        int s = height / 10;
        int k = s * 3 - s / 2;
        this.buttonList.add(new ImageButton(1, 10, k - s * 1, s, s, new ResourceLocation("Ares/Capes/moody/buttons/cape1.png")));
        this.buttonList.add(new ImageButton(2, 10, k, s, s, new ResourceLocation("Ares/Capes/moody/buttons/cape2.png")));
        this.buttonList.add(new ImageButton(3, 10, k + s * 1, s, s, new ResourceLocation("Ares/Capes/moody/buttons/cape3.png")));
        this.buttonList.add(new ImageButton(7, 10, k + s * 2, s, s, new ResourceLocation("Ares/Capes/moody/buttons/cape7.png")));
        this.buttonList.add(new ImageButton(4, 20 + s, k - s * 1, s, s, new ResourceLocation("Ares/Capes/moody/buttons/cape4.png")));
        this.buttonList.add(new ImageButton(5, 20 + s, k, s, s, new ResourceLocation("Ares/Capes/moody/buttons/cape5.png")));
        this.buttonList.add(new ImageButton(6, 20 + s, k + s * 1, s, s, new ResourceLocation("Ares/Capes/moody/buttons/cape6.png")));
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        ...
        if (button.id == 1) {
            ConfigManager.settings.capepath = "Ares/Capes/moody/cape1.png";
            ConfigManager.settings.AnimatedCape = false;
        }
        if (button.id == 2) {
            ConfigManager.settings.capepath = "Ares/Capes/moody/cape2.png";
            ConfigManager.settings.AnimatedCape = false;
        }
        if (button.id == 3) {
            ConfigManager.settings.capepath = "Ares/Capes/moody/cape3.png";
            ConfigManager.settings.AnimatedCape = false;
        }
        if (button.id == 4) {
            ConfigManager.settings.capepath = "Ares/Capes/moody/cape4.png";
            ConfigManager.settings.AnimatedCape = false;
        }
        if (button.id == 5) {
            ConfigManager.settings.capepath = "Ares/Capes/moody/cape5.png";
            ConfigManager.settings.AnimatedCape = false;
        }
        if (button.id == 6) {
            ConfigManager.settings.capepath = "Ares/Capes/moody/cape6.png";
            ConfigManager.settings.AnimatedCape = false;
        }
        if (button.id == 7) {
            ConfigManager.settings.capepath = "Ares/Capes/moody/cape7.png";
            ConfigManager.settings.AnimatedCape = false;
        }
        if (button.id == 14) {
