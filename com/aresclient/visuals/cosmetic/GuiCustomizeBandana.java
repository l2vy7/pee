...
import com.aresclient.visuals.cosmetic.GuiCustomizeBunnyEars;
 ...
 */
public class GuiCustomizeBandana
extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.buttonList.add(new ImageButton(99, width / 2 + Size * 1, height - Size - Size / 4 - this.i, Size, Size, new ResourceLocation("Ares/Icons/ColorPicker/White.png")));
        this.buttonList.add(new ImageButton(99, width / 2 + Size * 2, height - Size - Size / 4 - this.i, Size, Size, new ResourceLocation("Ares/Icons/ColorPicker/White.png")));
        this.buttonList.add(new ImageButton(99, width / 2 + Size * 3, height - Size - Size / 4 - this.i, Size, Size, new ResourceLocation("Ares/Icons/ColorPicker/White.png")));
        this.updatebuttons();
        ...
        int i = -100;
        int j = 10;
        GuiCustomizeBandana.drawEntityOnScreen((int)(i + 51), (int)(j + 75), (int)30, (float)((float)(i + 51) - this.oldMouseX), (float)((float)(j + 75 - 50) - this.oldMouseY), (EntityLivingBase)this.mc.thePlayer);
        GuiCustomizeBandana.drawEntityOnScreen((int)x, (int)y, (int)75, (float)(width / 2 - mouseX), (float)(height / 2 - mouseY - 60), (EntityLivingBase)this.mc.thePlayer);
    ...
    private void updatebuttons() {
        int s = height / 10;
        int k = s * 3 - s / 2;
        this.buttonList.add(new ImageButton(1, 10, k - s * 1, s, s, new ResourceLocation("Ares/cosmetic/bandana/button1.png")));
        this.buttonList.add(new ImageButton(2, 10, k, s, s, new ResourceLocation("Ares/cosmetic/bandana/button2.png")));
        this.buttonList.add(new ImageButton(3, 10, k + s * 1, s, s, new ResourceLocation("Ares/cosmetic/bandana/button3.png")));
        this.buttonList.add(new ImageButton(4, 20 + s, k - s * 1, s, s, new ResourceLocation("Ares/cosmetic/bandana/button4.png")));
        this.buttonList.add(new ImageButton(5, 20 + s, k, s, s, new ResourceLocation("Ares/cosmetic/bandana/button5.png")));
        this.buttonList.add(new ImageButton(6, 20 + s, k + s * 1, s, s, new ResourceLocation("Ares/cosmetic/bandana/button6.png")));
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        ...
        if (button.id == 2) {
            ConfigManager.settings.BandanaTexture = 2;
        }
        if (button.id == 3) {
            ConfigManager.settings.BandanaTexture = 3;
        }
        if (button.id == 4) {
            ConfigManager.settings.BandanaTexture = 4;
        }
        if (button.id == 5) {
            ConfigManager.settings.BandanaTexture = 5;
        }
        if (button.id == 6) {
            ConfigManager.settings.BandanaTexture = 6;
        }
        if (button.id == 7) {
            ConfigManager.settings.BandanaTexture = 7;
        }
        if (button.id == 15) {
            this.mc.displayGuiScreen((GuiScreen)new GuiCustomizeBlaze());
        }
        if (button.id == 16) {
            this.mc.displayGuiScreen((GuiScreen)new GuiCustomizeBunnyEars());
        }
        if (button.id == 17) {
