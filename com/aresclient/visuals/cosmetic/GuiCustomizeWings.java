 ...
 */
public class GuiCustomizeWings
extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        int i = -100;
        int j = 10;
        GuiCustomizeWings.drawEntityOnScreen((int)(i + 51), (int)(j + 75), (int)30, (float)((float)(i + 51) - this.oldMouseX), (float)((float)(j + 75 - 50) - this.oldMouseY), (EntityLivingBase)this.mc.thePlayer);
        GuiCustomizeWings.drawEntityOnScreen((int)x, (int)y, (int)75, (float)(width / 2 - mouseX), (float)(height / 2 - mouseY - 60), (EntityLivingBase)this.mc.thePlayer);
    ...
    private void updatebuttons() {
        int s = height / 10;
        int k = s * 3 - s / 2;
        this.buttonList.add(new ImageButton(1, 10, k - s * 1, s, s, new ResourceLocation("Ares/cosmetic/wings/button1.png")));
        this.buttonList.add(new ImageButton(2, 10, k, s, s, new ResourceLocation("Ares/cosmetic/wings/button2.png")));
        this.buttonList.add(new ImageButton(3, 10, k + s * 1, s, s, new ResourceLocation("Ares/cosmetic/wings/button3.png")));
        this.buttonList.add(new ImageButton(7, 10, k + s * 2, s, s, new ResourceLocation("Ares/cosmetic/wings/button7.png")));
        this.buttonList.add(new ImageButton(4, 20 + s, k - s * 1, s, s, new ResourceLocation("Ares/cosmetic/wings/button4.png")));
        this.buttonList.add(new ImageButton(5, 20 + s, k, s, s, new ResourceLocation("Ares/cosmetic/wings/button5.png")));
        this.buttonList.add(new ImageButton(6, 20 + s, k + s * 1, s, s, new ResourceLocation("Ares/cosmetic/wings/button6.png")));
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        ...
        if (button.id == 2) {
            ConfigManager.settings.WingsTexture = 2;
        }
        if (button.id == 3) {
            ConfigManager.settings.WingsTexture = 3;
        }
        if (button.id == 4) {
            ConfigManager.settings.WingsTexture = 4;
        }
        if (button.id == 5) {
            ConfigManager.settings.WingsTexture = 5;
        }
        if (button.id == 6) {
            ConfigManager.settings.WingsTexture = 6;
        }
        if (button.id == 7) {
            ConfigManager.settings.WingsTexture = 7;
        }
        if (button.id == 14) {
