 ...
 *  com.aresclient.visuals.cosmetic.GuiOnlineCosmetics
 ...
 */
public class GuiOnlineCosmetics
extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        int i = -100;
        int j = 10;
        GuiOnlineCosmetics.drawEntityOnScreen((int)(i + 51), (int)(j + 75), (int)30, (float)((float)(i + 51) - this.oldMouseX), (float)((float)(j + 75 - 50) - this.oldMouseY), (EntityLivingBase)this.mc.thePlayer);
        GuiOnlineCosmetics.drawEntityOnScreen((int)x, (int)y, (int)75, (float)(width / 2 - mouseX), (float)(height / 2 - mouseY - 60), (EntityLivingBase)this.mc.thePlayer);
