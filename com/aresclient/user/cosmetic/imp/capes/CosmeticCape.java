 ...
 *  com.aresclient.user.cosmetic.imp.capes.CosmeticCape
...
implements LayerRenderer<AbstractClientPlayer> {
    ...
    public void doRenderLayer(AbstractClientPlayer entitylivingbaseIn, float p_177141_2_, float p_177141_3_, float partialTicks, float p_177141_5_, float p_177141_6_, float p_177141_7_, float scale) {
        if (entitylivingbaseIn.hasPlayerInfo() && !entitylivingbaseIn.isInvisible() && ConfigManager.settings.capemode.equals("ares") && entitylivingbaseIn.getLocationAresCape() != null) {
            GlStateManager.color((float)1.0f, (float)1.0f, (float)1.0f, (float)1.0f);
            this.playerRenderer.bindTexture(entitylivingbaseIn.getLocationAresCape());
            ...
            this.playerRenderer.getMainModel().renderAresCape(0.0625f);
