 ...
 *  com.aresclient.user.cosmetic.imp.capes.OptifineCape
...
implements LayerRenderer<AbstractClientPlayer> {
    ...
    public OptifineCape(RenderPlayer playerRendererIn) {
        this.playerRenderer = playerRendererIn;
    }

    public void doRenderLayer(AbstractClientPlayer entitylivingbaseIn, float p_177141_2_, float p_177141_3_, float partialTicks, float p_177141_5_, float p_177141_6_, float p_177141_7_, float scale) {
        if (entitylivingbaseIn.hasPlayerInfo() && !entitylivingbaseIn.isInvisible() && ConfigManager.settings.capemode.equals("optifine") && entitylivingbaseIn.getLocationOptifineCape() != null) {
            GlStateManager.color((float)1.0f, (float)1.0f, (float)1.0f, (float)1.0f);
            this.playerRenderer.bindTexture(entitylivingbaseIn.getLocationOptifineCape());
